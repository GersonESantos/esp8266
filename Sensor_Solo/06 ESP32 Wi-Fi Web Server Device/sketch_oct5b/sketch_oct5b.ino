/***********************************************************************
 * PROJETO: Sistema de Irrigação com Painel de Controle Web
 * DESCRIÇÃO: Controla uma bomba e monitora a umidade do solo com
 * uma interface web moderna e responsiva.
 ***********************************************************************/
...
int  soilMoistureValue = 0; // Valor bruto do sensor
...
<head>
    ...
    <style>
        ...
        .gauge-label { margin-top: 10px; font-weight: 700; font-size: 1.1rem; }
    </style>
</head>
<body>
    <div class="container">
        ...
        function updateSensorData() {
            fetch('/data')
                ...
                .then(data => {
                    ...
                    // Atualiza o medidor de umidade
                    // Assumindo que 4095 é seco e 0 é muito úmido. Ajuste se necessário.
...
void setup() {
    ...
    digitalWrite(RELAY_PIN, pumpState); // Garante que o relé comece no estado inicial (desligado)
